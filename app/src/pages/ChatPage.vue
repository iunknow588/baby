<template>
  ...
  <section v-if="chatUiReady" class="panel" style="padding: 0; overflow: hidden">
    <vue-advanced-chat
      ...
      :loading-rooms.prop="chat.loadingRooms"
      :rooms-loaded.prop="chat.roomsLoaded"
      :messages-loaded.prop="chat.messagesLoaded"
      :show-audio.prop="true"
      :show-files.prop="true"
      :show-emojis.prop="true"
