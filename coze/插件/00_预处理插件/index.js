...
class PaperPreprocessPlugin {
  ...
  async execute(params) {
    ...
    const payload = {
      ...
      headerSuppressionDiagnostics: result.headerSuppressionDiagnostics || null,
      segmentationReadyDiagnostics: result.segmentationReadyDiagnostics || null,
      ...
      fallbackReadableRefinement: result.fallbackReadableRefinement || null,
